...
const Testimonial = () => {
    const testimonials = [
        ...
        },
        {
            ...
            image: assets.testimonial_image_1,
            testimonial: "I highly recommend CarRental! Their fleet is amazing, and i always feel like i'm grtting the best deal with excellent service."
        },
    ];
                    ...
                    <div key={index} className="bg-white p-6 rounded-xl shadow-lg max-w-xs hover:-translate-y-1 transition-all duration-500">
                        ...
                        <div className="flex items-center gap-1 mt-4">
                            {Array(5).fill(0).map((_, index) => (
                                <img src={assets.star_icon} key={index} alt='star_icon' />
                            ))}
                        </div>
